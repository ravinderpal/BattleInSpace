...
function preload() {
  ...
  game.load.image('space', 'assets/viaggio.png');
  game.load.image('bullet', 'assets/elephant.png');
  game.load.image('ship', 'assets/Hannibal.png');
  game.load.image('asteroid1', 'assets/soldier.png');
  game.load.image('asteroid2', 'assets/soldier.png');
  game.load.image('asteroid3', 'assets/soldier.png');
...
var score=0, spaceshipHealth = totHealth = 200;
var aMaxSize=0.5, nAsteroids=50, aSpeed=300;
var spaceHeight = 2000, spaceWidth = 1249;
var bulletTime = 0;
...
function create() {
  ...
  scoreText = game.add.text(100, 60, 'War booty: 0', { fontSize: '32px', fill: '#d8137e' });
  scoreText.fixedToCamera = true;
  healthText = game.add.text(100, 20, 'Health: ' + spaceshipHealth, { fontSize: '32px', fill: '#d8137e'});
  healthText.fixedToCamera = true;
  aAlive = game.add.text(100, 100, 'Romans left: ', { fontSize: '32px', fill: '#d8137e'});
...
function update() {
  aAlive.text = "Romans left: "+asteroids.total;
  ...
  scoreText.text = 'War booty: ' + score.toFixed(0);
